...
const App = () => {
    ...
    useEffect(() => {
        ...
        //Probleme big Mistake 2
        // [
        //     empty,rock_black,empty,empty,empty,empty,empty,king_black,
        //     empty,empty,empty,empty,empty,empty,pawn_black,empty,
        //     rock_black,empty,empty,knight_white,pawn_black,empty,empty,empty,
        //     pawn_black,empty,queen_white,pawn_black,empty,pawn_black,empty,pawn_black,
        //     empty,empty,empty,empty,empty,pawn_white,empty,empty,
        //     empty,empty,pawn_white,empty,pawn_white,empty,empty,empty,
        //     pawn_white,pawn_white,empty,empty,bishop_black,pawn_white,empty,pawn_white,
        ...
        async function BotToPlay(color) {
            compteur ++
            indexReview++;
            zz("#videSon").play();
